...
export class CoeServerStatusUiController {
    ...
    public updateButtonState() {
        ...
        if (coe.isRunning()) {
            button.innerHTML = 'Stop <span id="coeIconColor" style="color:green" class="glyphicon glyphicon-one-fine-dot"></span>';
            console.log("button: ", button);
            button.setAttribute('onclick', 'coeViewController.stopCoe()');
            icon.style.color = 'green';
        } else {
            button.innerHTML = 'Launch <span id="coeIconColor" style="color:red" class="glyphicon glyphicon-one-fine-dot"></span>';
